...
namespace Prueba_TravelGateX
{
    ...
    class Atalaya_Rooms_Manager
    {
        ...
        /// cargamos los datos tal y como se crea el objeto para tenerlo disponible en el momento que se necesite.
        /// creamos y almacenamos la respuesta con los tipos de habitaciones disponibles para cada hotel en la lista "Received_Data".
        public Atalaya_Rooms_Manager()  
        {
            WebClient Client = new WebClient(); 
            string Received_Data = Client.DownloadString("https://run.mocky.io/v3/132af02e-8beb-438f-ac6e-a9902bc67036"); 
        ...
        public string Room_Name(string room)  
        {
