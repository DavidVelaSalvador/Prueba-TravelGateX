...
namespace Prueba_TravelGateX
{
    ...
    class Resort_Hotel_Manager
    {
        ...
        {
            foreach (Resort_hotel Temp_Hotel in Hotel_List.hotels) /// recorremos la lista de hoteles comparando el
                                                                   /// code de cada hotel con el code que nos pasan por parametros.
            {
